...
export function Testimonials() {
  ...
  return (
    <section id="customers" className="overflow-hidden border-y border-border bg-card/40 py-28">
      ...
      <div className="mt-12 relative">
        ...
        >
          {loop.map((t, i) => (
            <figure
              key={i}
              className="w-[360px] shrink-0 rounded-2xl border border-border bg-background p-7"
            >
